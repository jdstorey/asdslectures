...
```{r animation_ex, message=FALSE, cache=TRUE, warning=FALSE, fig.show="animate"}
p <- ggplot(gapminder) +
...
```{r animation_ex2, message=FALSE, cache=TRUE, warning=FALSE, fig.show="animate"}
p <- ggplot(gapminder) +
  geom_density(aes(x=lifeExp, color=as.factor(year), 
                   frame=year), 
               size=1.2) +
...
```{r animation_ex3, message=FALSE, cache=TRUE, warning=FALSE, fig.show="animate"}
p <- ggplot(gapminder) +
  geom_density(aes(x=lifeExp, color=as.factor(year), 
